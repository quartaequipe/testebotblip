...
var BlipChat = exports.BlipChat = function () {
  ...
  _createClass(BlipChat, [{
    ...
    key: 'withCustomStyle',
    value: function withCustomStyle(style) {
    ...
    value: function build() {
      this.widget = new _BlipChatWidget.BlipChatWidget(this.appKey, this.buttonConfig, this.authConfig, this.account, this.target, this.events, this.environment || "production", this.customStyle);
    }
  }, {
    key: 'toogleChat',
...
var BlipChatWidget = exports.BlipChatWidget = function () {
  function BlipChatWidget(appKey, buttonConfig, authConfig, account, target, events, environment, customStyle) {
    ...
    value: function _onReceivePostMessage(message) {
      switch (message.data.code) {
        case _Constants2.default.CHAT_READY_CODE:
          ...
          blipChatButton.classList.add('opened');
          self._checkFullScreen();
          self._sendPostMessage({ code: _Constants2.default.CUSTOM_STYLE_CODE, customStyle: self.customStyle });
          break;
...
var CUSTOM_STYLE_CODE = 'CustomStyle';
